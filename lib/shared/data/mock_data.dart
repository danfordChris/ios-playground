class MockData {
  ...
  static const tickets = [
    ...
    },
    {
      ...
      'assignedDate': '2026-06-18T10:00:00Z',
      'department': 'Engineering',
      'visibility': 'Standard',
      'slaStatus': 'On Track',
      'slaTarget': '3 business days',
      'slaDue': '2026-06-21T18:00:00Z',
    ...
    },
    {
      ...
      'assigneeName': 'Erick',
      'assignedBy': 'Jane Doe',
      'assignedDate': '2026-06-14T12:00:00Z',
      'department': 'Product Design',
      'visibility': 'Standard',
      'slaStatus': 'Completed',
      'slaTarget': '5 business days',
      'slaDue': '2026-06-18T11:45:00Z',
    ...
    },
    {
      ...
      'assigneeName': 'IT Support',
      'assignedBy': 'Erick',
      'assignedDate': '2026-06-10T10:30:00Z',
      'department': 'Finance',
      'visibility': 'Standard',
      'slaStatus': 'Completed',
      'slaTarget': '4 hours',
      'slaDue': '2026-06-12T16:20:00Z',
      'createdAt': '2026-06-10T08:45:00Z',
      'updatedAt': '2026-06-12T16:20:00Z',
    },
    {
      'id': 't-5',
      'title': 'Private HR concern about reassignment communication',
      'description':
          'An employee reported a sensitive issue about reassignment communication and asked for HR review before manager involvement.',
      'priority': 'High',
      'status': 'Open',
      'category': 'HR Issue',
      'reporter': 'Joseph Haule',
      'reporterId': 'u-6',
      'reporterName': 'Joseph Haule',
      'assigneeId': 'u-2',
      'assigneeName': 'Sarah Jenkins',
      'assignedBy': 'Neema Mollel',
      'assignedDate': '2026-06-19T09:30:00Z',
      'department': 'HR',
      'visibility': 'Restricted HR Ticket',
      'slaStatus': 'On Track',
      'slaTarget': '24 hours',
      'slaDue': '2026-06-20T09:10:00Z',
      'createdAt': '2026-06-19T09:10:00Z',
      'updatedAt': '2026-06-19T09:30:00Z',
    },
  ];

  static const mockDepartments = [
    'Operations',
    'Finance',
    'HR',
    'Engineering',
  ...
  static const ticketComments = [
    ...
    },
    {
      ...
      'authorName': 'Sarah Jenkins',
      'content':
          'Internal note: keep this restricted to HR until the employee is ready for a broader update.',
